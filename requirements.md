...
| M4: 閲覧モード | +2ヶ月 | 画面遷移図、コメント、共有リンク、mock 実行プレビュー、**デザインシステムエディタ(トークン + コンポーネントバリアント、FR-DS-08)**、**設計図エクスポート(遷移図 / シーケンス図 / レイヤー×機能マトリクス、FR-VIEW-06)**、**カタログのヘッドレス仕様化(FR-GUI-08)** |
