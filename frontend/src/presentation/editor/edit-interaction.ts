...
import type { ComponentType, GridLayout, NodeStyle } from '@/domain/component-node';
...
export type EditInteraction = Readonly<{
  ...
  /** ノードの style をパッチ更新する(辺リサイズハンドルの確定時など) */
  onStyle: (nodeId: NodeId, patch: NodeStyle) => void;
}>;
