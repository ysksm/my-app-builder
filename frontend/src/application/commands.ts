...
const componentType = z.enum([
  'container', 'heading', 'text', 'button', 'input', 'image', 'table', 'header', 'footer', 'metric', 'gauge', 'lamp', 'chart', 'setpoint', 'uplot', 'echarts', 'aggrid', 'disclosure', 'menu', 'switch', 'rating', 'slider', 'chip',
]);
