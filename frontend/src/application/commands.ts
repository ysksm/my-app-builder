...
export type Command =
  ...
  | Readonly<{ kind: 'setNodeName'; target: EditTarget; nodeId: NodeId; name: string }>
  // ページ
...
const componentType = z.enum([
  'container', 'heading', 'text', 'button', 'input', 'image', 'table', 'header', 'footer', 'metric', 'gauge', 'lamp', 'chart', 'setpoint', 'uplot', 'echarts', 'aggrid', 'form', 'disclosure', 'menu', 'switch', 'tabs', 'rating', 'slider', 'chip', 'alert', 'badge', 'avatar', 'combobox', 'progress', 'searchfield',
]);
...
const commandSchema = z.discriminatedUnion('kind', [
  ...
  z.object({ kind: z.literal('setNodeName'), target: editTarget, nodeId: id, name: z.string() }),
